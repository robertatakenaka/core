...
class AMHarvester:
    ...
    def __init__(
        ...
        """
        self.base_url = "https://articlemeta.scielo.org/api/v1/article/identifiers"
            ...
            try:
                ...
                for item in objects:
                    ...
                    xml_url = (
                        ...
                        f"collection={self.collection_acron}&code={pid_v2}&format=xmlrsps"
                    )
