        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "declared_name",
                    models.TextField(
                        blank=True, null=True, verbose_name="Declared Name"
                    ),
                ),
                (
                    "declared_acronym",
                    models.TextField(
                        blank=True, null=True, verbose_name="Declared Acronym"
                    ),
                ),
                (
                    "std_name",
                    models.TextField(
                        blank=True, null=True, verbose_name="Standardized Name"
                    ),
                ),
                (
                    "std_acronym",
                    models.CharField(
                        ...
                        max_length=32,
                        null=True,
                        verbose_name="Standardized Acronym",
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "official",
                    models.BooleanField(
                        blank=True, default=None, null=True, verbose_name="FIXME"
                    ),
                ),
            ],
        ),
